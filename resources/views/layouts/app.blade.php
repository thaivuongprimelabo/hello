        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="{{url::to('/admin')}}" class="logo">
                    ...
                    <span class="logo-lg"><b>Zenrin</b>Data</span>
                </a>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a  class="btn btn-default btn-flat" href="{{ url('auth/logout') }}"
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <?php $url = URL::current();?>
                        <li {{ strpos($url, 'dashboard') ? 'class=active' : '' }} ><a href="/admin"><i class="fa fa-link"></i> <span>管理画面TOP</span></a></li>
                        <li {{ strpos($url, 'monitoring') ? 'class=active' : '' }}><a href="/admin/monitoring"><i class="fa fa-link"></i> <span>音声通知履歴</span></a></li>
                        <li {{ strpos($url, 'users') ? 'class=active' : '' }}><a href="/admin/users"><i class="fa fa-link"></i> <span>ユーザー管理</span></a></li>
                        <li {{ strpos($url, 'masters') ? 'class=active' : '' }}><a href="/admin/masters"><i class="fa fa-link"></i> <span>マスター管理</span></a></li>
                        <li {{ strpos($url, 'settings') ? 'class=active' : '' }}><a href="/admin/settings"><i class="fa fa-link"></i> <span>設定管理</span></a></li>
                    </ul>
                    <!-- /.sidebar-menu -->
                </section>
                <!-- /.sidebar -->
