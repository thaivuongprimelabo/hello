    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <p class="login-box-msg">ユーザーIDとパスワードを入力してください。</p>
                @if ($errors->has('loginid') || $errors->has('password'))
                <span class="help-block"><small><font color="red"><center>ログインに失敗しました。ユーザーIDかパスワードのどちらかが間違っています。</center></font></small></span>
                @endif
                <form  method="POST" action="{{ url('/auth/checklogin') }}">
                    ...
                    <div class="row">
                        <div class="col-xs-8"><small>デモログイン:<br/>U: songviytuong / P: cadillac</small></div>
                        <!-- /.col -->
                        <div class="col-xs-4">
